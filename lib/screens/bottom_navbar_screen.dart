              ...
              items: List.generate(
                ...
                (i) {
                  ...
                  return BottomNavigationBarItem(
                    label: tab['label'],
                    icon: Image.asset(
                      currentIndex != i ? tab['icon'] : tab['icon2'],
                      width: 24,
                      height: 24,
